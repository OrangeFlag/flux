...
//func createIntervalWindowTransformation(id execute.DatasetID, mode execute.AccumulationMode, spec plan.ProcedureSpec, a execute.Administration) (execute.Transformation, execute.Dataset, error) {
//	s, ok := spec.(*WindowProcedureSpec)
//	if !ok {
//		return nil, nil, errors.Newf(codes.Internal, "invalid spec type %T", spec)
//	}
