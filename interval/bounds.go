...
// SetStart sets the start on a given Bounds
func (b Bounds) SetStart(start values.Time) {
	b.start = start
}

// SetStop sets the stop on a given Bounds
func (b Bounds) SetStop(stop values.Time) {
	b.stop = stop
}
